                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype=multipart/form-data>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="prefixname" type="text" class="form-control @error('prefixname') is-invalid @enderror" name="prefixname" value="{{ old('prefixname') }}" autocomplete="prefixname" autofocus>
                                    <option value=""></option>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <select id="suffixname" type="text" class="form-control @error('suffixname') is-invalid @enderror" name="suffixname" value="{{ old('suffixname') }}" autocomplete="suffixname" autofocus>
                                    <option value=""></option>
